...
public class RainSplash extends ParticleBase {
    public RainSplash(ClientWorld world, Vector3 pos, FabricSpriteProvider spriteProvider) {
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            RainSplash particle = new RainSplash(world, new Vector3(x, y, z), spriteProvider);

...
public class Updraft extends ParticleBase {
    public Updraft(ClientWorld world, Vector3 pos, FabricSpriteProvider spriteProvider) {
...
/*    @Override
    public void buildGeometry(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
        ...
        RenderHelper.render_particle_quad(vertexConsumer, camera, tickDelta, this, new RenderParams(Vector3.ZERO.to_3f(), 0, 1), new Vector3(90,180,180));
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            Updraft particle = new Updraft(world, new Vector3(x, y, z), spriteProvider);
